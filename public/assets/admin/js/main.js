...
$(document).ready(function () {
  ...
  $("#toggleCheckbox3").change(function () {
    $(".field_show_3").toggle(this.checked);
  });
  $(".field_show_1").toggle($("#toggleCheckbox").is(":checked"));
  $(".field_show_2").toggle($("#toggleCheckbox2").is(":checked"));
  $(".field_show_3").toggle($("#toggleCheckbox3").is(":checked"));
...
// annimation
$(document).ready(function () {
  $(".menu_list_items > a").on("click", function () {
    var $parentLi = $(this).closest("li");

    $parentLi.toggleClass("clicked_sub");
    var $submenu = $(this).siblings(".menu_list_ul_sub");
...
$(document).ready(function () {
  // Open the popup
  $(".main-checkout form button, a.item_img ").on("click", function (e) {
    e.preventDefault();
    $(".main-checkout .for-popup, .popup_media").css("display","flex");
  });

  // Close the popup
  $(".close_btn").on("click", function () {
    $(".main-checkout .for-popup, .popup_media").css("display", "none");
  });
});