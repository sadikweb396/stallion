                            ...
                            @csrf
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  <input type="text"name="heading"value="@if($whatwedo){{$whatwedo->heading}}@endif"required/>
                              ...
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  <textarea name="paragraph"id="text">@if($whatwedo){{$whatwedo->paragraph}}@endif</textarea>
                                </div>
                              </div>      
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  <img id="imagePreview"src="@if($whatwedo){{url($whatwedo->image)}}@endif"style="max-width: 300px;">
                                </div>
                              </div>                        
