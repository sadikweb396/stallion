...
<div class="dash_body_inner">
                                ...
                                <div class="form-group">
                                  <div id="dynamicInputContainer">
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="plan" name="plan_details[]" placeholder="Enter value" style="width:95%;">
  ...
  $('#dynamicInputContainer').on('click', '.add-input', function () {
    const newInputGroup = `
      <div class="input-group">
        <input type="text" class="plan" name="input[]" placeholder="Enter value" style="width:95%;margin-top:10px;">
