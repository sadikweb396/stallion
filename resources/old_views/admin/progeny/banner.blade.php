                      ...
                      <div class="main_tab_content">
                        <div class="main_stallions_d">
                          <div class="title_bar mb20">
                            <p class="text-center">Progeny Banner</p>
                          </div>
                          <div class="stallions_d_form mb50">
                          <form method="post"action="{{ route('admin.progeny.banner-store') }}"enctype='multipart/form-data'>
                            @csrf
                              <div class="form_main">
                              ...
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  <textarea name="text">@if($banner){{$banner->text}}@endif</textarea>
                                </div>
                              </div>      
                              <div class="form_main">
                                <div class="form-group">
