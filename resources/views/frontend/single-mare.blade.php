...
<section
    ...
    <section id="categorySlider_mare" class="categorySlider categorySlider_design1 stallion-category">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
    ...
    <section class="progeny_main_m single_stallions_m">
    ...
    <!-- Mares section end -->
    <!-- Category Slider start -->
    <section id="categorySlider_mare" class="categorySlider stallion-category categorySlider_design_txt_hover">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div
    ...
    <section class="main_tab_m pdb100 relative main_tab_mare">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
    ...
    <!-- Category Slider start -->
    <section id="categorySlider_mare" class="categorySlider stallion-category">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
           <div class="slider_title mb50">
              <h3 class="text-center">MOre Animals by the SAME OWNER</h3>
            </div>
            <div
              id="catslider_gallery"
              class="catslider owl-carousel owl-theme"
            ...
            @if($stallionImage)
              <div class="item">
                <a href="javascript:void(0)">
                  <div
                    class="catimg d-flex align-items-end justify-content-center"
                    style="background-image: url('{{url( $stallionImage->stallion_image) }}');">
                    <div class="cattitle">
