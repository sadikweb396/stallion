...
<section class="hero_banner_m d-flex align-items-center"
    ...
    <!-- celender slider end -->
    <!-- pricing plan start -->
    @php $planmemberdetails=DB::table('planmembers')->first(); @endphp
    ...
    <section id="plans_pricing" class="">
      <div class="heading_sec">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
             @if($planmemberdetails)
              <div class="pricing_info">
                <div class="Pricing_sub_heading text-center">
                <h5>@if($planmemberdetails){{$planmemberdetails->text}}@endif</h5>
                </div>
                <div class="pricing_heading text-center mb20">
                  <h3>@if($planmemberdetails){{$planmemberdetails->title}}@endif</h3>
                </div>
                <div class="pricing_para text-center">
                  <p>
                  @if($planmemberdetails){{$planmemberdetails->description}}@endif
                  </p>
                </div>
              </div>
             @endif
                ...
                <div class="pricing_items">
                  ...
                  <div class="pricing_listing">
                    ...
                    @foreach($plandetails as $plandetail)
                      <li>
                        <span class="check_listing"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path></svg></span>Personalized profile
                      </li>
                    @endforeach    
                    </ul>
                    @endif
    ...
    @php $planOwnerdetails=DB::table('planowers')->first(); @endphp
    <!-- pricing plan end -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="pricing_info">
                <div class="Pricing_sub_heading text-center">
                  <h5>{{$planOwnerdetails->text}}</h5>
                </div>
                <div class="pricing_heading text-center mb20">
                  <h3> {{$planOwnerdetails->title}}</h3>
                </div>
                <div class="pricing_para text-center">
                  <p>
                  {{$planOwnerdetails->description}}
                  </p>
                </div>
              </div>
              @endif
