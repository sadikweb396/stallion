  ...
  .main_stallion_list > div {
    flex: 0 40%;
        ...
        .semen_contrat_pdf  a {
            ...
            color: blue; /* Default color for the link */
        }
...
<section   
                ...
                <div class="pedigree_chart_m">
                  <div class="chart_tree">
                    <ul class="list-none">
                      ...
                      <a href="@if($pedigree) {{url('single-stallion/'.$pedigree->stallionregistration)}} @endif" class="black-node"target="_blank">@if($pedigree) {{$pedigree->stallionregistration}} {{$pedigree->stallionname}}   @endif  @if($pedigree) {{$pedigree->stallionname}} @endif
                      </a>
    ...
    >
    @php $advertisements=DB::table('advertisements')->where('page','Single Stallion')->get(); @endphp
    ...
    <section class="semen_contrat_pdf semen_contract_f ">
        <div class="container">
            <div class="row">
              <div class="col-lg-12">
          ...
          <div class="col-lg-12">
            <div class="semen_contract_i">
              ...
              <div class="form-container">
                <form method="post"action="{{route('semen-contract')}}">
                  @csrf
                  ...
                  <div class="mare_details_m">
                    ...
                    <div class="row">
                      <div class="form-group">
                        ...
                        <input type="text" id="mare-name" name="mare_name" />
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select id="breeding-type" name="breeding_type">
