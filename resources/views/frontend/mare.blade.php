...
@section('content')
    ...
    <section
      id="categorySlider_mare"
      class="pdb100 categorySlider stallion-category mares_category bottom_line"
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
    ...
    <section class="about_stallions pdb100 about_mares">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
