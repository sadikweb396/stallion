                            ...
                            <form action="{{route('owner.semen-contract')}}"method="post">
                              ...
                              <div class="form_main">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" id="email" value="@if(isset($vetdetail)) {{$vetdetail->phone}} @endif"name="phone" />
                                  
                                </div>
                                <div class="form-group">
                                  <label for="email"> Email </label>
                                  <input type="email" id="email" value="@if(isset($vetdetail)) {{$vetdetail->email}} @endif"name="email" />
