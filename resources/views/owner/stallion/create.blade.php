  ...
  <div id="myModal" class="modal">
   ...
   <script>
        ...
        ClassicEditor
            ...
            const performanceHistory = document.getElementById('performance_history'); 
            if (performanceHistory.value.trim() === '') {
                // alert('Textarea cannot be empty!');
              messageDisplay.textContent = this.value ? `You typed: ${this.value}` : '';
