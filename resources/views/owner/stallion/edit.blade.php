                        ...
                        <div class="main_stallions_d">
                          ...
                          <div class="stallions_d_form mb50">
                            <form action="{{route('owner.stallion.update')}}"method="post">
                                @csrf
                              <input type="hidden"name="stallion_id"value="{{$id}}"id="stallion_id">
                              <div class="form_main">
                    ...
                    <div class="tab-content" id="tab-4">
                      <div class="main_tab_content">
                        <div class="main_stallions_d main_stallions_semen">
                          ...
                          <div class="stallions_d_form mb50">
                            <form action="{{route('owner.semen-contract')}}"method="post"enctype="multipart/form-data">
                                @csrf
                              <input type="hidden"name="stallion_id"value="{{$id}}">
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  >
                                    <div class="checkbox-group_i mb20">
                                      <label
                                        ><input
                                          type="checkbox"
                                          id="toggleCheckbox3"name="live_cover"value="Live Cover" @if($semencontract)@if($semencontract->live_cover == 'Live Cover') checked @endif @endif
                                        />
                                        Live Cover
                                      </label>
                                    </div>
                                    ...
                                    <div class="inner_field field_show_3">
                                      <div class="form-group">
                                        <label
                                          ><input type="checkbox"name="live_cover_lfg"value="Livecover LFG" @if($semencontract)@if($semencontract->live_cover_lfg == 'Livecover LFG') checked @endif @endif/> LFG(Tick If
                                          You gave live foal guarantee)</label
                                        >
                                      </div>
                                    </div>
                                    <div class="inner_field field_show_3">
                                      ...
                                      >
                                        ...
                                        <input
                                          type="text"
                                          id="Price-You-want-to-offer"
                                          name="live_cover_price"value=" @if($semencontract) {{$semencontract->live_cover_price}} @endif"
                                        />
                            ...
                            >
                              ...
                              <article class="stallion_items text-center">
                                <div class="label_edit_m d-flex justify-space-between mb20">
                                  ...
                                  <a href="{{url('owner/stallion/progeny',$progeny->id)}}">
                                    <button class="btn">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#model').append('<p>Another progeny is already exceptional. Do you want to be this progeny exceptional?</p><div class="confirm"><p id="confirm">Confirm</p><p id="cancel">Cancel</p></div>');
                    } 
                }
            });
        }
