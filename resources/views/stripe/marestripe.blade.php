    ...
    <div class="for-popup d-flex align-items-center justify-content-center" style="display: flex">
      ...
      <div class="credit-card-box">
        ...
        <form 
                            ...
                            action="{{ route('mare.stripe.store') }}" 
                    ...
                    <div class='col-md-12 error form-group hide'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary btn-lg btn-block" type="submit"> <i class="fa fa-lock"></i>
                                <span class="dynamic_price"> $ 784</span> / Proceed</button>
