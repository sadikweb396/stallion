...
$(document).ready(function(){ 
    ...
    $('.declineBtn').click(function(){
        ...
        openPopup('Are you sure you want to decline?', url, 'POST');
    });
    ...
    $('.approveBtn').click(function(){
        var id = $(this).data('id');
        url = '{{ url('admin/approve') }}/' + id;  
        openPopup('Are you sure and want to approve?', url, 'POST');
    });

    // Open popup
    function openPopup(message, url, method) {
        $('#model').empty();
        $('#model').append('<div class="popup-overlay">' +
                           ...
                           '<a class="popup-button confirm-btn" id="confirmActionBtn">Confirm</a>' +
                           '<a class="popup-button cancel-btn" id="cancelBtn">Cancel</a>' +
                           '</div>' +
                           '</div>' +
                           '</div>');
        ...
        $(document).on('click', '#cancelBtn, #closePopup', function() {
            $('#model').empty();  // Close the pop-up
        });
    }
});
