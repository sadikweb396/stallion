                    ...
                    <div class="">
                      <div class="main_tab_content">
                        <div class="main_stallions_d">
                          ...
                          <form method="post"action="{{route('admin.photographer.edit') }}"enctype='multipart/form-data'>
                            @csrf
                              <div class="form_main">
                              ...
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="name"name="travel_radius" />
                                </div>
                              </div>
                              <div class="form_main">
                                <div class="form-group">
                                  <label for="name">Individual Price</label>
                                  <input type="text" id="name"name="individual_price" />
                                </div>
                              </div>
                              <div class="form_main">
                                <div class="form-group">
                                  <label for="name">Multi Price</label>
                                  <input type="text" id="name"name="multi_price" />
                                </div>
                              </div>
