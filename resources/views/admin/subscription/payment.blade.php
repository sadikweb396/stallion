...
@section('content')
    ...
    <div class="for-popup d-flex align-items-center justify-content-center" style="display: flex">
      ...
      <div class="credit-card-box">
         ...
         <form  role="form"  action="{{ route('renew-subscription-payment') }}"  method="post" class="require-validation"
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group card required'>
                                 ...
                                 <input autocomplete="off" class="form-control card-number input-cart-number" id="card-number" maxlength="16" size="14" type="text">
