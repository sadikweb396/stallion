                      ...
                      <div class="main_tab_content">
                        <div class="main_stallions_d">
                          <div class="title_bar mb20">
                            <p class="text-center">Topside</p>
                          </div>
                          <div class="stallions_d_form mb50">
                          <form method="post"action="{{route('admin.topside.store') }}"enctype='multipart/form-data'>
                            @csrf
                              <div class="form_main">
                                <div class="form-group">
                                  <label for="name">Heading </label>
                                  <textarea name="heading"id="topsideheading">{{$topside->heading}}</textarea>
                                </div>
                              </div>
                              <div class="form_main">
                                <div class="form-group">
                                  <label for="name">Paragraph</label>
                                  <textarea name="paragraph"id="topsideparagraph">{{$topside->paragraph}}</textarea>
                                </div>
                              </div>
                              <div class="form_main">
                                <div class="form-group">
