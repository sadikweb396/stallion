                    ...
                    <div class="">
                      <div class="main_tab_content">
                        <div class="main_stallions_d">
                          ...
                          <form method="post"action="{{route('admin.mare-details.store') }}"enctype='multipart/form-data'>
                            @csrf
                              <div class="form_main">
                              ...
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  <input type="file" id="name"name="banner_image"@if(!$maredetails) required @endif/>
                                </div>
                              </div>
                              <div class="form_main">
                                <div class="form-group">
                              ...
                              <div class="form_main">
                                <div class="form-group">
                                  ...
                                  <input type="file" id="name" name="image" @if(!$maredetails) required @endif/>
                                </div>
                              </div>
