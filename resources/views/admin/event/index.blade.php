            ...
            <div class="col-lg-12">  
              <div class="profile_status_m mb20">
                ...
                <div class="all_user_title">
                  <p class="mb20">All Event</p>
                  <div class="add_user">
                      @can('create user')
                      <a href="{{ url('admin/event/create') }}" class="btn btn-primary float-end btn btn_i black_btn">Add Event</a>
                      @endcan
                      </div>
                  </div>  
                  <div class="searchbar">
                    ...
                    <table class="content-table" id="myTable">
                      <thead>
                        <tr>
                          <th>Image</th>
                          <th>Name</th>
                          <th>Association Hosting Event</th>
                          <th>Start Date</th>
                          <th>End Date</th>
                          <th>Event Type</th>
                          <th>Action</th>
                     ...
                     <div class="pagination d-flex justify-content-center" id="pagination">{{ $events->links() }}</div>
                    </div>
                  </div>
                </div>
              </div>
