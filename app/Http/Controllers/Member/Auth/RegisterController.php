...
class RegisterController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $planPrice=plan::where('plan_for','member')->value('plan_price');
        ...
        return view('member.payment.registerpayment')->with('planPrice',$planPrice);
    ...
    public function paymentregister(Request  $request)
    {
        ...
        $plan=DB::table('plans')->where('plan_for',$roles)->first();
